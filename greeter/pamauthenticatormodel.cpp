...
{
    auto isEnabled = [](const auto &string) {
    ...
    constexpr auto fingerprintEnabled = isEnabled(KSCREENLOCKER_PAM_FINGERPRINT_SERVICE);
    constexpr auto faceEnabled = isEnabled(KSCREENLOCKER_PAM_FACE_SERVICE);
    constexpr auto universal2factorEnabled = isEnabled(KSCREENLOCKER_PAM_UNIVERSAL2FACTOR_SERVICE);
    constexpr auto smartcardEnabled = isEnabled(KSCREENLOCKER_PAM_SMARTCARD_SERVICE);
...
void PAMAuthenticatorModel::defunct(PamAuthenticators::Authenticator authenticator) const
{
